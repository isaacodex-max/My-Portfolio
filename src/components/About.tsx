      ...
      <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-12 sm:mb-16">
        ...
        <div className="flex justify-center lg:justify-start order-1 lg:order-1">
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-gray-800 via-gray-800 to-black rounded-2xl blur-lg"></div>
            <img 
              src="/lovable-uploads/aa365eb7-f26f-4dd2-b635-f0a462613689.png" 
              alt="CodeMax - Full Body Professional Photo"
              className="relative w-64 sm:w-80 lg:w-96 h-auto object-cover rounded-2xl shadow-xl border border-yellow-600"
            />
          </div>
        </div>
        ...
        <div className="space-y-4 sm:space-y-6 order-2 lg:order-2 text-center lg:text-left">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-4 pt-4 justify-center lg:justify-start">
            <span className="px-3 sm:px-4 py-2 bg-black text-yellow-300 rounded-full text-sm">React</span>
            <span className="px-3 sm:px-4 py-2 bg-black text-yellow-300 rounded-full text-sm">TypeScript</span>
            <span className="px-3 sm:px-4 py-2  bg-black text-yellow-300 rounded-full text-sm">Tailwind CSS</span>
            <span className="px-3 sm:px-4 py-2 bg-black text-yellow-300 rounded-full text-sm">Next.js</span>
          </div>
        </div>
      </div>
      
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        <div className="bg-slate-800/50 backdrop-blur-sm p-4 sm:p-6 rounded-xl border border-yellow-600 hover:border-black transition-all duration-300">
          <Code className="text-yellow-600 mb-3 sm:mb-4" size={28} />
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm p-4 sm:p-6 rounded-xl border border-yellow-600 hover:border-black  transition-all duration-300">
          <Palette className="text-yellow-600 mb-3 sm:mb-4" size={28} />
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm p-4 sm:p-6 rounded-xl border border-yellow-600 hover:border-black transition-all duration-300 sm:col-span-2 lg:col-span-1">
          <Zap className="text-yellow-600 mb-3 sm:mb-4" size={28} />
