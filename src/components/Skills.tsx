    ...
    <section id="skills" className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
        {skills.map((skill, index) => (
          <div 
            key={skill.name} 
            className="bg-slate-800/50 backdrop-blur-sm p-4 sm:p-6 rounded-xl border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 animate-fade-in"
